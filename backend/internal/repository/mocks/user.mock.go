...
// Source: backend/internal/repository/user.go
...
func (m *MockUserRepository) FindByWechat(ctx context.Context, info domain.WechatInfo) (domain.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) FindByWechat(ctx, info interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
